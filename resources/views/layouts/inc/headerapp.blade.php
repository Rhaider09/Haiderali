            ...
            <div class="grow">
                <div class="flex space-x-0 md:space-x-14">
                    ...
                    <div class="space-x-2 hidden md:flex items-center">
                        <i class="fa-brands fa-whatsapp text-sky-400"></i>
                        <a href="https://wa.me/+923230436771" class="text-black text-base">+923230436771</a>
                    </div>
                </div>
            </div>
            <div class="flex items-center space-x-6">
                <a href="https://wa.me/+923230436771" class="group transition-all text-black hover:text-sky-400" target="_blank" rel="noopener noreferrer">
                    <i class="fa-brands fa-whatsapp"></i>
                </a>
                <a href="https://github.com/Rhaider09" class="group transition-all text-black hover:text-sky-400" target="_blank" rel="noopener noreferrer">
                    <i class="fa-brands fa-github"></i>
                </a>
                <a href="https://stackoverflow.com/users/23036570/haider-ali" class="group transition-all text-black hover:text-sky-400" target="_blank" rel="noopener noreferrer">
                    <i class="fa-brands fa-stack-overflow"></i>
                </a>
                <a href="https://www.linkedin.com/in/haider-ali-amjad-a89438236/" class="group transition-all text-black hover:text-sky-400" target="_blank" rel="noopener noreferrer">
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="{{ url('/') }}" class="hover:text-sky-500 block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700" data-dropdown-delay="500" data-dropdown-trigger="hover">Home</a>
                        </li>
                        <li>
