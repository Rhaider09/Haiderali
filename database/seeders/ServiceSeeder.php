...
class ServiceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        [
            'title'=>'Dynamic web apps with Angular',
            'description'=>'Proficient in developing dynamic and responsive web applications using Angular, a powerful front-end framework. Experienced in building modular components, implementing two-way data binding, and optimizing performance for seamless user experiences.',
            'images'=>'angular.png',
            'thumbnail'=>'angular.png',
        ],
        [
            'title'=>'Efficient UIs using React',
            'description'=>'Skilled in building interactive and efficient user interfaces with React, a popular JavaScript library. Capable of creating reusable components, managing state effectively, and integrating with various backend technologies to deliver robust and scalable web applications',
            'images'=>'react.jpg',
            'thumbnail'=>'react.jpg',
        ],
        [
            'title'=>'Scalable backend with Node.js.',
            'description'=>'Adept at server-side development using Node.js, leveraging its non-blocking, event-driven architecture. Experienced in building RESTful APIs, handling asynchronous operations, and deploying scalable backend solutions for web applications.',
            'images'=>'nodejs.png',
            'thumbnail'=>'nodejs.png',
        ],
        [
            'title'=>'Versatile C# for robust applications.',
            'description'=>'Proficient in C#, a versatile programming language used for developing robust and scalable applications on the Microsoft .NET framework. Skilled in object-oriented programming, building desktop applications, and creating web services with ASP.NET.',
            'images'=>'cshp.png',
            'thumbnail'=>'cshp.png',
        ],
        [
            'title'=>'Boost Your Website’s SEO Ranking with Expert web Development..',
            'description'=>'Maximize your website’s SEO ranking by leveraging the power of web. Specializing in robust and scalable application development, we ensure your digital presence is optimized with high-performance solutions. Skilled in object-oriented programming and creating dynamic web services with ASP.NET to enhance your sites visibility.',
            'images'=>'seo_csharp.png',
            'thumbnail'=>'seo_csharp_thumb.png',
        ],
